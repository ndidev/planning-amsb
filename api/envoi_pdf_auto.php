...
if (empty($_POST) && !DateUtils::verifierJourOuvre(AUJOURDHUI)) {
...
foreach ($configs as $config) {
   ...
   */
  $date_debut = DateUtils::jourOuvrePrecedent(AUJOURDHUI, (int) $jours_avant);
  $date_fin = DateUtils::jourOuvreSuivant(AUJOURDHUI, (int) $jours_apres);
