...
final class DateUtilsTest extends TestCase
{
  ...
  {
    $date = "2022-01-01";
    $this->assertTrue(DateUtils::verifierJourFerie(new DateTime($date)));
  }

  public function testVerifierLundiPaquesFerie(): void
  {
    $paques = "2022-04-18";
    $this->assertTrue(DateUtils::verifierJourFerie(new DateTime($paques)));
  }

  public function testVerifierJeudiAscensionFerie(): void
  {
    $ascension = "2022-05-26";
    $this->assertTrue(DateUtils::verifierJourFerie(new DateTime($ascension)));
  }

  public function testVerifierLunidiPentecoteFerie(): void
  {
    $pentecote = "2022-06-06";
    $this->assertTrue(DateUtils::verifierJourFerie(new DateTime($pentecote)));
  }

  public function testVerifierJourOuvre(): void
  {
    $date = "2022-01-03";
    $this->assertTrue(DateUtils::verifierJourOuvre(new DateTime($date)));
  }
  ...
  public function testJourOuvreSuivant(): void
  {
    $date = "2022-01-01";
    $expected = "2022-01-03";
    $actual = DateUtils::jourOuvreSuivant(new DateTime($date));
  ...
  public function testJourOuvrePrecedent(): void
  {
    $date = "2022-06-07";
    $expected = "2022-06-03";
    $actual = DateUtils::jourOuvrePrecedent(new DateTime($date));
    $this->assertEquals($expected, DateUtils::format(DateUtils::ISO_DATE, $actual));
  }
