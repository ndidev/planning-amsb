...
{
  private BulkService $produitService;
  private $module = "vrac";
  ...
  public function __construct(
    ...
    $this->produitService = new BulkService();
    $this->processRequest();
  }
  ...
  public function readAll()
  {
    ...
    $produits = $this->produitService->getProducts();
    ...
    $this->response
      ->setBody(
        json_encode(
          array_map(fn (BulkProduct $produit) => $produit->toArray(), $produits)
        )
      )
  ...
  public function read(int $id, ?bool $dry_run = false)
  {
    ...
    $produit = $this->produitService->getProduct($id);
  ...
  public function create()
  {
    ...
    $produit = $this->produitService->createProduct($input);
  ...
  public function update(int $id)
  {
    ...
    if (!$this->produitService->productExists($id)) {
      $this->response->setCode(404);
      return;
    }
    ...
    $produit = $this->produitService->updateProduct($id, $input);
