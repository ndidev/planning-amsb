...
use Api\Models\Bois\HeureRDVModel;
use Api\Utils\BaseController;
use Api\Utils\ETag;

use Api\Utils\Exceptions\Auth\AccessException;

class HeureRDVController extends BaseController
{
  private $model;
  private $module = "bois";
